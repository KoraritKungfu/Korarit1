                    ...
                    <tbody>
                      @foreach ($content as $Content)
                        <tr>
                            ...
                            <td><a href="{{url('/admin/content/edit/'.$Content->id_contents)}}" class="btn btn-sm btn-primary">แก้ไข</a></td>
                            <td><a href="{{url('/admin/content/delete/'.$Content->id_contents)}}" class="btn btn-sm btn-danger">ลบ</a></td>
                        </tr>
                      @endforeach
                    </tbody>
                  </table>
